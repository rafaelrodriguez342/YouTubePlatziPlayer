...
public class Constants {
    public static final String YOUTUBE_API_KEY = "AIzaSyBfi07_JiX6p_eNXCxiYGQNTOTlGb_MR1U";
    public static final String YOUTUBE_REQUEST_PLATZI_LIST_ID = "PLa28R7QEiMblmIF4y_ydG4eRr5K4TcVyk";
